<?php
    ...
    $stmt = $connessione->prepare("SELECT * FROM `utenti` WHERE email = ?"); // guardo se esiste il nome utente inserito
    ...
    $stmt = $connessione->prepare("INSERT INTO utenti(email, password) VALUES (?, ?)");
